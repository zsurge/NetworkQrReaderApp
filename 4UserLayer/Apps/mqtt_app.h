...
#define DEVICE_NAME    	"admin"																//用户注册设备时生成的设备唯一编号，支持系统自动生成，也可支持用户添加自定义编号，产品维度内唯一
...
#define USER_NAME			DEVICE_NAME         //客户端用户名
#define PASSWORD			"adminlvjh123!@#"   //客户端登录password通过hmac_sha1算法得到，大小写不敏感
